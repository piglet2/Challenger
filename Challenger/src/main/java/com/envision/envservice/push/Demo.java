...
public class Demo {
	...
	public Demo() {
		try {
//			appkey = mapConfigService.getValue("appkey");
//			appMasterSecret =mapConfigService.getValue("appMasterSecret");
//			System.out.println(appkey);
//			System.out.println(appMasterSecret);
			appkey="5636f3b867e58ef961002288";
			appMasterSecret="jfdzxeki5b93xenirrbq9gxcr91uqwvs";
		} catch (Exception e) { 
			e.printStackTrace();
			System.exit(1);
		}
	...
	public void sendAndroidUnicast() throws Exception {
		...
		unicast.setDeviceToken( "AjgoixXLYJuuP7QyQsqRTZgWZlhPY2SbfBrw9HyhVSVZ");
