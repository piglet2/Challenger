...
import com.envision.envservice.dao.ClgApplicationDao;
import com.envision.envservice.entity.dto.ClgApplication;


/**
 * @ClassName ClgApplicationService
 * @author song.cai
 * @date 2016-12-8
 */
@Service
public class ClgApplicationService {
	...
	@Autowired
	private ClgApplicationDao clgApplicationDao;
	
	public List<ClgApplication> queryClgApplication() {
		List<ClgApplication> list=clgApplicationDao.queryAll();
		return list;
	}
