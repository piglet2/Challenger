 ...
 * @author caisong
 */
public interface WordRateDao {
	
	public int addWordRate(WordRate wordRate);

	@SuppressWarnings("rawtypes")
	public WordRate queryByPeriodIdAndManagerIdAndUserId(Map map);
	
	@SuppressWarnings("rawtypes")
	public int deleteByPeriodIdAndManagerIdAndUserId(Map map);
