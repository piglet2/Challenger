...
public class PicUtil {
	...
	private static final Logger LOGGER = EnvLog.getLogger(PicUtil.class);
	...
	private static void initPicDir() throws IOException {
		File picPath = new File(Constants.PIC_BASE + Constants.PIC_PATH);
		if (!picPath.exists()) {
			picPath.mkdir();
		}
	}
