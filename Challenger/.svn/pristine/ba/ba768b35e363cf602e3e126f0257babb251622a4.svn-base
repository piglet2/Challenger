/******************************************************************************
 * @File name   :      ChallengeLevelETRule.java
 *
 ...
 * 		返回: 通过:True
 * 
 * @ClassName ChallengeLevelETRule
 * @author guowei.wang
 * @date 2015-11-10
 */
@Component("challengeLevelETRule")
public class ChallengeLevelETRule extends P2PRuleItem {
	...
	public boolean valid(String userId, String userIdTarget) throws Exception {
		...
		return ChallengeLevelUtil.isET(challengeLevel, challengeLevelTarget);
	}
}
